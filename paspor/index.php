...
<head>
    ...
    <style>
        ...
        .header { background: #006eb3; color: white; padding: 15px; border-radius: 5px; margin-bottom: 20px; }
        ...
        .navbar a.active { background: #004eb3; color: white; }
...
<div class="header">
    ...
    <p><strong>Programmer:</strong> Nida A'maliah(221011403026)</p> 
</div>
